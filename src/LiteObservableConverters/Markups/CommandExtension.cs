...
public class CommandExtension(string executeName) : MarkupExtension, ICommand
{
    private readonly string _executeName = executeName;
    ...
    public CommandExtension(string executeName, string canExecuteName) : this(executeName)
    {
    ...
    public bool CanExecute(object? parameter)
    {
        if (_canExecute == null)
        {
            ...
            _canExecute = (args) => (bool)method.Invoke(context, hasParameter ? [args] : null)!;
        }
